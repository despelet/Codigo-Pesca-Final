...
// //const connection = require("./../productos")
...
//     sentencia = 'select * from indumentaria'; 
...
//   sentencia = 'select * from indumentaria where id = ' +  req.params.id
...
//     if (error) throw error;
//     // res.json({mensaje: "Se ha dado de baja el producto seleccionado"})
